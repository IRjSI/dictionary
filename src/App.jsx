...
function App() {
  ...
  return (
    <div className="flex flex-col justify-center items-center font-poppins min-h-screen bg-gray-900">
      <div className="text-white text-xl mt-8 mb-24 absolute top-4">
      ...
      <div className="flex justify-center items-center flex-col">
        <form className="flex" onSubmit={findWord}>
          <input
            ...
            className="p-2 rounded-lg bg-opacity-15 bg-black w-full border-2 border-gray-500 focus:outline-none text-white z-40"
            value={query}
        ...
        {meaning && (
          <div className="flex flex-col text-white mt-4 w-[300px] sm:w-[400px] gap-5 bg-gray-800 p-6 rounded-lg shadow-md">
            <ul className="space-y-3">
              <li>
                <strong className="text-2xl">{meaning.word}</strong>
              </li>
              <li>
              ...
              {meaning.pronunciation ? (
                ...
                <li className="text-gray-500">No pronunciation available</li>
              )}
            </ul>
          </div>
        )}
